    ...
    projects: [
      {
        ...
        desc:"The Appli web application design is an online electronics appliance store application that is used for purchasing different types of electronic appliance. The great thing about this online electronics appliance store application is that, as a user, you can view a catalogue of the different types of electronic appliance before purchase. While working on the design for this application, I thought about how I could make the application 'user friendly', seamless, enjoyable and functional. I also worked on how to enhance the customer's experience while using the application by incorporating aesthetically pleasing colors, images and design ethics in the design. The aim of the design is to provide an opportunity for people to purchase furniture from a store and get it delivered to them in their homes without the individuals having to leave their homes."
      },
      {
        title: "Meat - O",
        yearExecuted: 2021,
        ...
        desc: "The Meat - O web application design is an online meat store application that is used for purchasing different types of meat. The great thing about this online meat store application is that, as a user, you can view a catalogue of the different types of meat before purchase. While working on the design for this application, I thought about how I could make the application 'user friendly', seamless and enjoyable. I also worked on how to enhance the customer's experience while using the application by incorporating aesthetically pleasing colors and images in the design. The aim of the design is to provide an opportunity for people to purchase meat from a store and get it delivered to them in their homes without the individuals having to leave their homes.",
      },
      {
        title: "FurLok",
        yearExecuted: 2021,
        ...
        desc: "The Furlok web application design is an online furniture store application that is used for purchasing different types of furniture. The great thing about this online furniture store application is that, as a user, you can view a catalogue of the different types of furniture before purchase. While working on the design for this application, I thought about how I could make the application 'user friendly', seamless and enjoyable. I also worked on how to enhance the customer's experience while using the application by incorporating aesthetically pleasing colors, images and design ethics in the design. The aim of the design is to provide an opportunity for people to purchase furniture from a store and get it delivered to them in their homes without the individuals having to leave their homes.",
      },
      {
        title: "RaleShield",
        yearExecuted: 2020,
